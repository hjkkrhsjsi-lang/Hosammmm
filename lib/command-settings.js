...
const COMMAND_DEFS = [
  { key: 'ليون',                   name: '!ليون',                      cat: 'general', desc: 'اسأل شخصية ليون أي سؤال' },
  { key: 'اشلي',                   name: '!اشلي',                      cat: 'general', desc: 'اسأل شخصية اشلي أي سؤال' },
  ...
  { key: 'استريك',                 name: '!استريك',                    cat: 'general', desc: 'يحوّل صورة/جيف/فيديو قصير لاستيكر' },
  { key: 'صورة',                   name: '!صورة',                      cat: 'general', desc: 'يحوّل استيكر لصورة عادية (عكس !استريك)' },
  { key: 'كشف',                    name: '!كشف',                       cat: 'general', desc: 'يرجع صورة/فيديو/صوت "يظهر مرة وحدة" (رد عليها بالأمر)' },
  { key: 'اغنية',                  name: '!اغنية',                     cat: 'general', desc: 'يدور على أغنية بالاسم أو رابط ويبعتها بلاغ صوتي' },
  ...
  { key: 'توقف_تشغيل',             name: '!توقف / !تشغيل',             cat: 'admin', desc: 'يوقف أو يشغّل ردود ليون واشلي' },
