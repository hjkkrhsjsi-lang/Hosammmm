...
// يعتمد على حزمة youtube-dl-exec (لازم تنزلها: npm install youtube-dl-exec) + ffmpeg-static
// (موجودة أصلاً بالمشروع، مستخدمة بملف media.js).
// ⚠️ هالحزمة تحتاج Python 3.7+ متوفر بالسيرفر كـ "python3"، وإلا برمي خطأ.
//
