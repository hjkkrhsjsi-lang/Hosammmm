...
const HUQOQ_VIDEO_FILENAME = 'VID_20260721_170815.mp4'; // فيديو مخصص لأمر "حقوق بوت" - لسا مش مرفوع بالسيرفر، فالأمر بيفشل برسالة واضحة لحد ما يترفع
...
const MENU_VIDEO_FILENAME = 'VID_20260803_223533.mp4'; // فيديو خاص بقائمة !اوامر الرئيسية - لسا مش مرفوع، فالأمر بيرجع النص بس بدون فيديو لحد ما يترفع
...
// ============ تحويل استيكر (webp) لصورة عادية (png) - لأمر !صورة ============
async function stickerBufferToImageBuffer(stickerBuffer) {
