...
async function downloadQuotedMedia(quotedMessage) {
  ...
  else if (quotedMessage.stickerMessage) { content = quotedMessage.stickerMessage; type = 'sticker'; mimetype = quotedMessage.stickerMessage.mimetype; } // 🆕 لأمر !صورة
  else if (quotedMessage.audioMessage) { content = quotedMessage.audioMessage; type = 'audio'; mimetype = quotedMessage.audioMessage.mimetype; }
